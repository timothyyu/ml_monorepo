...
class ols:
    ...
    def summary(self):
        ...
        for i in range(len(self.x_varnm)):
            print '''% -10s          % 10.6f     % 10.6f     % 10.6f     % 10.6f''' % tuple([self.x_varnm[i],self.b[i],self.se[i],self.t[i],self.p[i]]) 
        #print '=============================================================================='
        #print 'Models stats                              Residual stats'
        #print '=============================================================================='
        print 'R-squared            % 12.6f         Durbin-Watson stat  % 12.6f' % tuple([self.R2, self.dw()])
        print 'Adjusted R-squared   % 12.6f         Omnibus stat        % 12.6f' % tuple([self.R2adj, omni])
        print 'F-statistic          % 12.6f         Prob(Omnibus stat)  % 12.6f' % tuple([self.F, omnipv])
        print 'Prob (F-statistic)   % 12.6f         JB stat             % 12.6f' % tuple([self.Fpv, JB])
        print 'Log likelihood       % 12.6f         Prob(JB)            % 12.6f' % tuple([ll, JBpv])
        print 'AIC criterion        % 12.6f         Skew                % 12.6f' % tuple([aic, skew])
        print 'BIC criterion        % 12.6f         Kurtosis            % 12.6f' % tuple([bic, kurtosis])
        print '=============================================================================='
    ...
    def summary_short(self):
        ...
        #print '=============================================================================='
        for i in range(len(self.x_varnm)):
            print '''% -20s          % 10.6f     % 10.6f     % 10.6f     % 10.6f''' % tuple([self.x_varnm[i],self.b[i],self.se[i],self.t[i],self.p[i]]) 
        #print '=============================================================================='
        #print 'Models stats                              Residual stats'
        #print '=============================================================================='
        print 'R-squared            % 12.6f         Skew                % 12.6f' % tuple([self.R2, skew])
        print 'Adjusted R-squared   % 12.6f         Kurtosis            % 12.6f' % tuple([self.R2adj, kurtosis])
        print '=============================================================================='
